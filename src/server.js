...
const data = {
  ...
  following_url:
    "https://api.github.com/users/satyadev-mishra/following{/other_user}",
  gists_url: "https://api.github.com/users/satyadev-mishra/gists{/gist_id}",
  starred_url:
    "https://api.github.com/users/satyadev-mishra/starred{/owner}{/repo}",
  subscriptions_url:
    "https://api.github.com/users/satyadev-mishra/subscriptions",
  ...
  received_events_url:
    "https://api.github.com/users/satyadev-mishra/received_events",
  type: "User",
